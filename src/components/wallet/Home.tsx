...
import {
  ...
  mintOneToken,
  shortenAddress,
} from "../candy_machine/candy-machine";
...
const Home = (props: HomeProps) => {
  ...
  return (
    <main>
      {showWallet && (
        <div style={{ backgroundColor: '#ccff00', fontWeight: 'bold', borderRadius: '15px', padding: '15px', marginBottom: '1rem' }}>
          {wallet && (
      ...
      <MintContainer className={`${wallet && 'btn-clr'}`}>
        {!wallet ? (
